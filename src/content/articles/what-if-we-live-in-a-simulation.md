---
type: article
title: What if we Live in a simulation?
description: A small article talking about the possibility of living in a simulation
date: 2026-01-03T21:30:00
tags:
  - philosophy
  - metaphysics
  - posthuman
...
Let:
- $f_P$: fraction of civilisations that reach the posthuman stage
- $f_I$: fraction of posthuman civilisations interested in running ancestor simulations
- $N_I$: average number of simulations run by interested civilisations
- $f_{\text{sim}}$:  fraction of observers with human-like experiences that are simulated

The fraction of observers with human-like experiences that are simulated is:


$$
f_{\text{sim}} = \frac{f_P \cdot f_I \cdot N_I}{f_P \cdot f_I \cdot N_I + 1}
$$
...
### What this means?
Well, there's not really a solid conclusion to this theory because it puts some very interesting further questions about the simulation and overlords.
I mean does the simulation really need to simulate everyone or just you? Maybe all this is a simulation of your own qualia and you're never meant to solve this while it's being rubbed in your face. It's also the argument for solipsism but that's just plain evil.
...
- *Brains in a Vat*  
  [https://philosophy.as.uky.edu/sites/default/files/Brains%20in%20a%20Vat%20-%20Hilary%20Putnam.pdf](Brat_in _a_Vat.pdf)
